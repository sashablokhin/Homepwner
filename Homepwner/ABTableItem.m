...
/*  
    ...
    Минусы архивирования по сравнению с Core Data: Для получения доступа к содержимому, находящемуся в архиве, следует разархивировать целый файл.
    Если же требуется сохранить какие-либо изменения, опять же переписывается файл целиком. 
    При использовании Core Data у нас появляется возможность выборки небольшого поднабора сохраненных объектов.
    Благодаря такой инкрементной выборке, обновлению, удалению и вставке производительность приложения улучшается, особенно при наличии большого количества объектов-моделей, которые постоянно передаются между файловой системой и оперативной памятью.
 */
